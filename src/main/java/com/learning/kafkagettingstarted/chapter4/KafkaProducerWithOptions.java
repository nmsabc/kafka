...
public class KafkaProducerWithOptions {
        ...
        public static void main(String[] args) {
                 ...
                 **************************************************************/
                // Create the record
                ProducerRecord<String, String> asyncNoChecksRec = new ProducerRecord<String, String>(
                 ...
                 **************************************************************/
                // Create the record
                ProducerRecord<String, String> syncRec = new ProducerRecord<String, String>(
                                "kafka.learning.orders", // Topic name
                                String.valueOf(randomKey.nextInt(1000)),
                ...
                try {
                        RecordMetadata retData = (RecordMetadata) optionsProducer
                                        .send(syncRec)
                ...
                // Create Message
                ProducerRecord<String, String> asyncRecCallBack = new ProducerRecord<String, String>(
                                "kafka.learning.orders", // Topic name
                                messageKey,
