...
// ConsumerRecord(topic = kafka.usecase.students, partition = 0, leaderEpoch =
// 0, offset = 4185, CreateTime = 1679058923637, serialized key size = 4,
// serialized value size = 76, headers = RecordHeaders(headers = [], isReadOnly
// = false), key = 1170, value =
// xybcbzqculfcgyuorhofiaortlrkwugcmplefmwbburbdslhvikswmomyuriuulydyxabggbxcnu)